...
(function () {
  var t = {
    ...
    666: function _(t) {
      var r = function (t) {
        ...
        function _(t, r) {
          function e(o, i, a, c) {
            ...
            if ("throw" !== s.type) {
              var u = s.arg,
                  h = u.value;
              return h && "object" == _typeof(h) && n.call(h, "__await") ? r.resolve(h.__await).then(function (t) {
                e("next", t, a, c);
              }, function (t) {
                e("throw", t, a, c);
        ...
        function j(t, e) {
          ...
          if (n === r) {
            if (e.delegate = null, "throw" === e.method) {
              if (t.iterator["return"] && (e.method = "return", e.arg = r, j(t, e), "throw" === e.method)) return d;
        ...
        return g.prototype = m, s(L, "constructor", m), s(m, "constructor", g), g.displayName = s(m, c, "GeneratorFunction"), t.isGeneratorFunction = function (t) {
          var r = "function" == typeof t && t.constructor;
          return !!r && (r === g || "GeneratorFunction" === (r.displayName || r.name));
        }, t.mark = function (t) {
          return Object.setPrototypeOf ? Object.setPrototypeOf(t, m) : (t.__proto__ = m, s(t, c, "GeneratorFunction")), t.prototype = Object.create(L), t;
        }, t.awrap = function (t) {
          return {
            __await: t
          };
        ...
        }, E(L), s(L, c, "Generator"), s(L, i, function () {
          return this;
  ...
  e.n = function (t) {
    ...
    var a = function () {
      var t = r(o().mark(function t(r) {
        var e, n, a;
        return o().wrap(function (t) {
          for (;;) {
            switch (t.prev = t.next) {
              case 0:
                return e = r ? "".concat(i).concat(r) : i, t.prev = 1, t.next = 4, fetch(e);
    ...
    var h;
    (h = r(o().mark(function t() {
      var r;
      return o().wrap(function (t) {
        for (;;) {
          switch (t.prev = t.next) {
            case 0:
              return r = document.getElementById("main"), t.next = 3, l();
